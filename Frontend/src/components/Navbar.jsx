...
const NAV_LINKS = [
  { to: '/dashboard',    label: 'Dashboard',     icon: LayoutDashboard, roles: ['Administrador', 'Recepcionista', 'PersonalLimpieza', 'ServicioTecnico', 'Huesped'] },
  ...
  { to: '/cleaning',     label: 'Limpieza',      icon: Sparkles,        roles: ['Administrador', 'PersonalLimpieza'] },
